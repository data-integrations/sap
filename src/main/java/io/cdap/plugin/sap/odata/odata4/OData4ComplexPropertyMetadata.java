...
/**
 * OData V4 complex property metadata.
 */
public class OData4ComplexPropertyMetadata extends PropertyMetadata implements ComplexPropertyMetadata {

  private final CsdlSchema schema;
  private final CsdlComplexType complexType;
  private final CsdlComplexType baseType;

  public OData4ComplexPropertyMetadata(String name, String edmTypeName, boolean isCollection, boolean isNullable,
                                       Integer precision, Integer scale, List<ODataAnnotation> annotations,
                                       CsdlSchema schema, CsdlComplexType complexType) {
